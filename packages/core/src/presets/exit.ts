...
export const exitPresets: Preset[] = [
  ...
  },
  {
    ...
    apply: (p, prm) => { const e = ease('easeInCubic', p); return { x: e * prm.distance, opacity: 1 - e }; },
  },
  {
    ...
    defaultDuration: 0.6, fromEnd: true,
    apply: (p, prm) => { const e = ease('easeInCubic', p); return { y: e * prm.distance, opacity: 1 - e }; },
  },
  {
    ...
    defaultDuration: 0.6, fromEnd: true,
    apply: (p, prm) => { const e = ease('easeInCubic', p); return { scale: 1 - (1 - prm.to) * e, opacity: 1 - e }; },
  },
  {
    ...
    defaultDuration: 0.6, fromEnd: true,
    apply: (p, prm) => { const e = ease('easeInOutCubic', p); return { blur: e * prm.blur, opacity: 1 - e }; },
  },
  {
    ...
    defaultDuration: 0.5, fromEnd: true, apply: (p, prm) => { const e = ease('easeInExpo', p); return { scale: 1 + (prm.to - 1) * e, opacity: 1 - e }; },
  },
  {
    id: 'out.slide-left', category: 'out', description: 'Slides off to the left while fading out.',
    tags: ['exit', 'directional'], params: { distance: { default: 120, min: 0, max: 800, unit: 'px' } },
    defaultDuration: 0.6, fromEnd: true, apply: (p, prm) => { const e = ease('easeInCubic', p); return { x: -e * prm.distance, opacity: 1 - e }; },
  },
  {
    ...
    defaultDuration: 0.6, fromEnd: true, apply: (p, prm) => { const e = ease('easeInCubic', p); return { y: -e * prm.distance, opacity: 1 - e }; },
  },
  {
    id: 'out.spin', category: 'out', description: 'Spins and shrinks away.',
    tags: ['exit', 'playful'], params: { turns: { default: 0.6, min: 0, max: 3 } },
    defaultDuration: 0.6, fromEnd: true, apply: (p, prm) => { const e = ease('easeInOutQuint', p); return { rotate: e * prm.turns * 360, scale: 1 - 0.6 * e, opacity: 1 - e }; },
  },
  {
    id: 'out.pop', category: 'out', description: 'Quick scale-up flicker then vanishes.',
    tags: ['exit', 'snappy'], params: {}, defaultDuration: 0.55, fromEnd: true,
    apply: (p) => { const e = ease('easeInCubic', p); return { scale: 1 + 0.25 * Math.sin(e * Math.PI), opacity: 1 - e }; },
  },
  {
  ...
  },
  {
    ...
    apply: (p, prm, ctx) => {
      const e = ease('easeInCubic', p); const j = Math.sin(ctx.time * 70) * prm.amount * e;
  ...
  },
  {
    ...
    defaultDuration: 0.7, fromEnd: true, apply: (p, prm) => { const e = ease('easeInCubic', p); return { y: e * prm.distance, rotate: e * prm.angle, opacity: 1 - ease('easeInCubic', p) }; },
  },
];
