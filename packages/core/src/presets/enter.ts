...
export const enterPresets: Preset[] = [
  ...
  },
  {
    ...
    defaultDuration: 0.6, apply: (p, prm) => { const e = ease('easeOutQuint', p); return { x: -(1 - e) * prm.distance, opacity: e }; },
  },
  {
  ...
  },
  {
    ...
    defaultDuration: 0.6, apply: (p, prm) => { const e = ease('easeOutQuint', p); return { y: (1 - e) * prm.distance, opacity: e }; },
  },
  {
    ...
    defaultDuration: 0.6, apply: (p, prm) => { const e = ease('easeOutBack', p); return { scale: prm.from + (1 - prm.from) * e, opacity: ease('easeOutQuint', p) }; },
  },
  {
    ...
    defaultDuration: 0.75, apply: (p, prm) => { const e = ease('easeOutExpo', p); return { rotate: (1 - e) * prm.turns * 360, scale: 0.4 + 0.6 * ease('easeOutBack', p), opacity: ease('easeOutCubic', p) }; },
  },
  {
    ...
    defaultDuration: 0.6, apply: (p, prm) => { const e = ease('easeOutExpo', p); return { blur: (1 - e) * prm.blur, opacity: ease('easeOutQuint', p) }; },
  },
  {
    ...
    defaultDuration: 0.65, apply: (p, prm) => { const e = ease('easeOutQuint', p); return { scale: prm.from - (prm.from - 1) * e, opacity: ease('easeOutQuint', p) }; },
  },
  {
    ...
    defaultDuration: 0.65, apply: (p, prm) => { const e = ease('easeOutBack', p); return { y: -(1 - e) * prm.distance, opacity: ease('easeOutCubic', p) }; },
  },
  {
    ...
    apply: (p) => { const e = ease('easeOutExpo', p); return { opacity: ease('easeOutCubic', p), css: { transform: `perspective(1000px) rotateX(${(1 - e) * 90}deg)` } }; },
  },
  {
    id: 'in.flip-y', category: 'in', description: 'Flips in around the vertical axis (3D card flip).',
    tags: ['enter', '3d'], params: {}, defaultDuration: 0.6,
    apply: (p) => { const e = ease('easeOutExpo', p); return { opacity: ease('easeOutCubic', p), css: { transform: `perspective(1000px) rotateY(${(1 - e) * 90}deg)` } }; },
  },
  {
    ...
    defaultDuration: 0.6, apply: (p, prm) => { const e = ease('easeOutQuint', p); return { x: (1 - e) * prm.distance, opacity: ease('easeOutCubic', p), css: { transform: `skewX(${(1 - e) * -prm.skew}deg)` } }; },
  },
  {
  ...
  },
  {
    ...
    defaultDuration: 0.8, apply: (p, prm) => { const e = ease('easeOutBack', p); return { y: -(1 - e) * prm.distance, scale: 0.9 + 0.1 * ease('easeOutBack', p), opacity: ease('easeOutCubic', p) }; },
  },
  {
    ...
    defaultDuration: 0.7, apply: (p, prm) => { const e = ease('easeOutExpo', p); return { opacity: ease('easeOutCubic', p), css: { transform: `perspective(1200px) rotateX(${-(1 - e) * prm.angle}deg)`, transformOrigin: 'top center' } }; },
  },
  {
    ...
    defaultDuration: 0.6, apply: (p, prm) => { const e = ease('easeOutExpo', p); return { scale: prm.from - (prm.from - 1) * e, blur: (1 - e) * prm.blur, opacity: ease('easeOutCubic', p) }; },
  },
  {
    ...
    defaultDuration: 0.7, apply: (p, prm) => { const e = ease('easeOutQuint', p); return { y: (1 - e) * prm.distance, rotate: (1 - e) * prm.angle, opacity: ease('easeOutQuint', p) }; },
  },
];
